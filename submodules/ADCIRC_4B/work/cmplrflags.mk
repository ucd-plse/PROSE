...
ifeq ($(compiler),gnu)
  ...
  PFC		:=  mpif90
  ifneq ($(VTUNE),)
    FFLAGS1	:=  $(INCDIRS) -O3 -mcmodel=medium -ffixed-line-length-none -march=core-avx2 -m64 -fdefault-real-8 -fdefault-double-8 -g -ginline-points
  else
    FFLAGS1	:=  $(INCDIRS) -O3 -mcmodel=medium -ffixed-line-length-none -march=core-avx2 -m64 -fdefault-real-8 -fdefault-double-8
  endif
  FFLAGS2	:=  $(FFLAGS1)
  FFLAGS3	:=  $(FFLAGS1)
  DA		:=  -DREAL8 -DLINUX -DCSCA
  ...
  CC		:= gcc
  CCBE		:= $(CC)
  CFLAGS	:= $(INCDIRS) -O2 -mcmodel=medium -DLINUX -march=core-avx2 -m64
  CLIBS	:=
  LIBS		:=
  MSGLIBS	:=
  ifeq ($(NETCDF),enable)
  ...
  ifneq ($(GPTL), )
    FLIBS += -L/glade/u/home/jdvanover/gptl-8.1.1/install-gcc/lib -lgptl -lgptlf -rdynamic
   #  FLIBS += -L/glade/u/home/jdvanover/gptl-8.1.1/install-gcc-pmpi/lib -lgptl -lgptlf -rdynamic
  endif

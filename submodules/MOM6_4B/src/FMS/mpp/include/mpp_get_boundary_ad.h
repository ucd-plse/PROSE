...
subroutine MPP_GET_BOUNDARY_AD_3D_V_(fieldx, fieldy, domain, ebufferx, sbufferx, wbufferx, nbufferx, &
  ...
  call MPP_GET_BOUNDARY_AD_3D_V_internal_(fieldx, fieldy, domain, ebufferx, sbufferx, wbufferx, nbufferx, &
    ebuffery, sbuffery, wbuffery, nbuffery, flags, gridtype, &
    complete, tile_count, domain%x(1)%memory%begin, domain%y(1)%memory%begin)
end subroutine MPP_GET_BOUNDARY_AD_3D_V_

subroutine MPP_GET_BOUNDARY_AD_3D_V_internal_(fieldx, fieldy, domain, ebufferx, sbufferx, wbufferx, nbufferx, &
                                  ebuffery, sbuffery, wbuffery, nbuffery, flags, gridtype, &
...
end subroutine MPP_GET_BOUNDARY_AD_3D_V_internal_

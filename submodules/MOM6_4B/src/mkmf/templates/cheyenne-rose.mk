...
# ROSE flags:
FFLAGS += -rose:plugin_lib ${PROSE_PLUGIN_PATH}/ProsePlugin.so -rose:plugin_action prose-generate-graph -rose:plugin_arg_prose-generate-graph ${PROSE_EXPERIMENT_DIR}

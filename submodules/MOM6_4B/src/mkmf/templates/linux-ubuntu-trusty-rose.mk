...
# ROSE flags:
FFLAGS += -rose:plugin_lib /root/precimonious-w-rose/plugins/ProsePlugin.so -rose:plugin_action prose-generate-graph -rose:plugin_arg_prose-generate-graph /root/MOM6-tuning/experiments/benchmark_star/
